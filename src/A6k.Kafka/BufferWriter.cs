...
namespace A6k.Kafka
{
    ...
    public ref partial struct MemoryWriter
    {
        ...
        /// </summary>
        private MemoryBufferWriter _output;
        ...
        public MemoryWriter(int initialSizeHint = 0)
        {
            _buffered = 0;
            _bytesCommitted = 0;
            _output = new MemoryBufferWriter();
            _span = _output.GetSpan(initialSizeHint);
        }
